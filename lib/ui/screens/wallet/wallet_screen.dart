          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Daily Expenses Tracking Account',
...
Widget _buildQuickActions() {
  return Row(
    mainAxisAlignment: MainAxisAlignment.spaceAround,
    children: [
      _buildActionIcon(Icons.send_rounded, 'Send'),
      _buildActionIcon(Icons.add_to_photos_rounded, 'Top Up'),
      _buildActionIcon(Icons.receipt_long_rounded, 'Bills'),
